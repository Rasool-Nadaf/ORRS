                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td class="px-0">
                                        <?php
                                        $from_route = isset($row['route_from']) ? $row['route_from'] : "N/A";
                                        $to_route = isset($row['route_to']) ? $row['route_to'] : "N/A";
                                        ?>
                                        <div class="px-1 border-bottom"><span class="text-muted">From:</span> <b><?= $from_route ?></b></div>
                                        <div class="px-1"><span class="text-muted">To:</span> <b><?= $to_route ?></b></div>
                                    </td>
